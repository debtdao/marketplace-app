...
// export const generateSubgraphTypes4 = (param: string = 'nothing'): void => {
//   console.log('successfully geneated ', param);
// };

// function generateSubgraphTypes3() {
//   console.log('successfully generated ');
// }

// export const generateSubgraphTypes2 = (url: string): void => {
//   // TODO: Add destination path for possibleTypes.js file.
//   const homeDirectory = path.resolve(process.cwd());
//   const destinationPath = path.join(homeDirectory + '/possibleTypes.js');
//   // console.log('path home: ', homeDirectory);
...
// module.exports = { generateSubgraphTypes3, generateSubgraphTypes4 };
