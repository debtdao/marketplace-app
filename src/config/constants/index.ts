...
const NETWORK_SETTINGS: NetworkSettings = {
  goerli: {
    ...
    networkId: 5,
    rpcUrl: 'https://eth-goerli.g.alchemy.com/v2/S20XF2kdhePxtKvHoiPjVZu5lCmDFyov',
    nativeCurrency: {
      name: 'ETH',
      symbol: 'GoerliETH',
      decimals: 18,
...
export const getConstants = memoize((): Constants => {
  ...
  return {
    ...
    DEBT_DAO_NETWORKS: ['mainnet', 'arbitrum', 'goerli'],
    NETWORK_SETTINGS,
    ...
    GOERLI_PROVIDER_HTTPS: 'https://eth-goerli.g.alchemy.com/v2/S20XF2kdhePxtKvHoiPjVZu5lCmDFyov',
    CONTRACT_ADDRESSES: {
