...
export const ReleaseCollateralTx: FC<BorrowCreditProps> = (props) => {
  ...
  return (
    <StyledTransaction onClose={onClose} header={header || t('components.transaction.release-collateral.header')}>
      <TxCreditLineInput
        key={'credit-input'}
